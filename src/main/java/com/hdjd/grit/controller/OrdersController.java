...
public class OrdersController {
    ...
    @ApiOperation(value = "增加配送信息", notes = "增加配送信息")
    public ResultInfo<Orders> deliver(@PathVariable("id")String id,
                                      String deliveryName, String deliveryPhone){
        Integer integer = ordersService.updateDriver(id, deliveryName, deliveryPhone);
        return integer.intValue() == 0 ? ResultInfoUtil.buildError(ApiConstant.ERROR_CODE, "操作失败") : ResultInfoUtil.build(ApiConstant.SUCCESS_CODE, "操作成功", null);
    }
}
