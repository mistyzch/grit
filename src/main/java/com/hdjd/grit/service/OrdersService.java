...
public class OrdersService {
    ...
    @Transactional(rollbackFor = Exception.class)
    public Integer updateDriver(String id, String deliveryName, String deliveryPhone){
        Orders orders = Orders.builder().id(id).deliveryName(deliveryName).deliveryPhone(deliveryPhone).build();
        return ordersMapper.updateById(orders);
    }
}
